        ...
        <div className="w-full min-h-screen bg-[#0f0f10] text-white font-sans flex justify-center px-4 py-8 lg:py-16">
            <div className="w-full max-w-[1400px] grid gap-8 grid-cols-1 lg:grid-cols-[minmax(200px,1fr)_minmax(0,800px)_minmax(200px,1fr)]">
                ...
                <aside className="hidden lg:flex flex-col gap-4 order-2 lg:order-1 lg:sticky lg:top-8 self-start">
                    <SidePanelCard title="Register Now!">
                        <div className="text-white text-sm">
                            Reserve your CODEWAVE handle before launch.
                        </div>
                        ...
                        <div className="mt-4">
                            <Mini3DButton
                                variant="register"
                                onClick={() => {
                                    // TODO: navigate to register / open modal etc.
                    ...
                    <SidePanelCard title="Join The Discord!">
                        <div className="text-white text-sm">
                            We're building this thing in public.
                        </div>
                        <div className="text-white/50 text-[0.7rem]">
                            Feedback gets shipped same day.
                        </div>
                        ...
                        <div className="mt-4">
                            <Mini3DButton
                                variant="discord"
                                onClick={() => {
                                    // e.g. window.open("https://discord.gg/yourinvite", "_blank")
                    ...
                    <SidePanelCard title="Check out Strudel!">
                        ...
                        <div className="mt-4">
                            <Mini3DButton
                                variant="strudel"
                                onClick={() => {
                                    // maybe scroll to the right-rail embed?
                                    console.log("Strudel clicked");
                                }}
                            />
                        </div>
                    </SidePanelCard>
                ...
                <aside className="flex flex-col gap-4 order-3 lg:order-3 lg:sticky lg:top-8 self-start">
                    ...
                    <SidePanelCard title="Status">
                        <div>Backend: online</div>
                        <div>Last sync: just now</div>
                    </SidePanelCard>

                    <SidePanelCard title="Context">
                        <div>Phase: Private alpha</div>
                        <div className="text-white/50 text-[0.7rem]">
                            You're seeing unreleased features.
                        </div>
                    </SidePanelCard>
                </aside>
            </div>
